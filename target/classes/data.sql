...
INSERT INTO product(name, description, price, quantity_available, tags, id_category, id_seller)
VALUES
    ('iPhone 14 Pro Max', 'iPhone reacondicionado con una condición excelente, garantizado.', 12000.00, 20, 'iphone, apple, reacondicionado', 1, 1),
    ('Samsung Galaxy S21 Ultra', 'Nuevo Samsung Galaxy con cámara de 108 MP y zoom de 100x.', 11000.00, 15, 'samsung, android, smartphone', 1, 2),
    ('MacBook Pro 2021', 'Potente computadora portátil con procesador M1 y pantalla Retina.', 18000.00, 12, 'macbook, apple, laptop', 1, 1),
    ('PlayStation 5', 'Consola de última generación con gráficos de alta calidad y 4K.', 8000.00, 25, 'playstation, videojuegos, consola', 3, 2),
    ('Nike Air Zoom Pegasus 38', 'Zapatillas de running con tecnología de amortiguación React.', 1500.00, 30, 'nike, zapatillas, deporte', 2, 1),
    ('Canon EOS R5', 'Cámara mirrorless con resolución de 45 MP y grabación de video en 8K.', 22000.00, 8, 'canon, cámara, fotografía', 4, 2),
    ('Smart TV LG OLED 4K', 'Televisor con tecnología OLED y resolución 4K para una experiencia de visualización inmersiva.', 9000.00, 18, 'lg, televisión, smart tv', 1, 1),
    ('FIFA 22 - Edición Deluxe', 'Videojuego de fútbol con nuevas características y gráficos mejorados.', 2500.00, 40, 'fifa, videojuego, deportes', 3, 2),
    ('Fitbit Versa 3', 'Smartwatch con seguimiento avanzado de actividad física y monitoreo de salud.', 1200.00, 22, 'fitbit, smartwatch, salud', 2, 1),
    ('Bose QuietComfort 45', 'Audífonos inalámbricos con cancelación de ruido y sonido de alta calidad.', 2800.00, 10, 'bose, audífonos, música', 1, 2),
    ('GoPro Hero 10 Black', 'Cámara de acción con capacidad para grabar videos en 5.3K y capturar fotos de alta resolución.', 4500.00, 15, 'gopro, cámara, acción', 4, 1);
